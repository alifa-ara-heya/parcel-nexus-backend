...
const statusLogSchema = new Schema<IStatusLog>({
    currentStatus: { type: String, enum: Object.values(ParcelStatus), required: true },
...
const parcelSchema = new Schema<IParcel>({
    ...
    currentStatus: { type: String, enum: Object.values(ParcelStatus), default: ParcelStatus.PENDING },

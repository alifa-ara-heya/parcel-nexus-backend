...
export const checkAuth = (...authRoles: string[]) => async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        // The database check is now handled by the refresh token logic.
        // This improves performance by trusting the short-lived access token.
        // The user's status will be re-validated upon token refresh.
